...
public class TileClimbable extends Tile implements ITileMirrorable
{
	...
	public TileClimbable(TileType type, String metadata, int innerType, float rotation, Vector2 position, Level level, Dimension dimension, TileProperty properties, boolean allowMirrors)
	{
