			...
			if (this.shootingProjectiles)
			{
				...
				if (this.shootingCooldown < 0)
				{
					...
					else
					{
						...
						EntityShadowBall projectile = (EntityShadowBall) Entity.createEntity(EntityType.SHADOWBALL, new Vector2(this.getCenterX(), this.getCenterY()), this.level, shared ? Dimension.COLORED : this.level.getBackgroundDimension(), false);
