...
public class TileCameraControl extends Tile
{
	...
	public TileCameraControl(TileType type, String metadata, int innerType, float rotation, Vector2 position, Level level, Dimension dimension, TileProperty properties, boolean allowMirrors)
	{
	...
	{
		return MapManager.getCameraControllers().size() > 2;
	}
