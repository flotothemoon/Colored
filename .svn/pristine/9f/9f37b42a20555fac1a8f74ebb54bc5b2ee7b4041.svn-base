...
public class EntityScientist extends EntityPlayer
{
	...
	public EntityScientist(Vector2 position, Level level, Dimension dimension, boolean allowMirrors)
	{
	...
	public LevelObject deepCopy(Map<Object, Object> copiedReferences)
	{
		...
		copy.distanceToPlayer = this.distanceToPlayer.cpy();
...
//				}
	...
	public void onUpdate(float delta, Random rng)
	{
		...
		super.updateMarkersAndZones(delta);
