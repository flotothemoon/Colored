...
public class ConfigFileHandler
{
	...
	public ConfigFileHandler(String path, boolean trimWhitespace) throws IOException
	{
		this(FileManager.getFile(path), null, DEFAULT_COMMENT_BEGIN, DEFAULT_SEPERATOR, trimWhitespace);
	}
	...
	public ConfigFileHandler(String path, Map<String, String> defaultValues, String commentBegin, String seperators,
	...
	public ConfigFileHandler(FileHandle handle, boolean trimWhitespace)
	{
		this(handle, null, DEFAULT_COMMENT_BEGIN, DEFAULT_SEPERATOR, trimWhitespace);
	}
	...
	public ConfigFileHandler(FileHandle handle, Map<String, String> defaultValues, String commentBegin,
			String seperators, boolean trimWhitespace)
	{
		if (handle == null)
		{
	...
	public void load(boolean reload) throws IOException
	{
		...
		InputStream in;
		BufferedReader reader = new BufferedReader(new InputStreamReader(in = handle.createInputStream()));
