...
public class EditWrapperPanel extends GUIPanel
{
	...
	public EditWrapperPanel(float xOffset, float yOffset, float width, float height)
	{
		...
		tintColorButton = new Button("", inputX, currentOffset, inputWidth, lineHeight, false)
		{
			@Override
			public void onClick()
			{
		...
		addTintColorButton = new Button("", inputX, currentOffset, inputWidth, lineHeight, false)
		{
			@Override
			public void onClick()
			{
		...
		alphaSlider = new Slider<Float>(inputX, currentOffset, inputWidth, lineHeight, 0.0f, null)
		{
			@Override
		...
		resetButton = new Button("Reset", (int) (xOffset), currentOffset, (int) (width), lineHeight, false)
		{
			@Override
			public void onClick()
			{
	...
	protected void customRender(float alphaFactor, Batch batch)
	{
		...
		Renderer.drawString("DrawSubImages", xOffset + 5, drawSubImages.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("ShouldClip", xOffset + 5, shouldClip.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("ShouldStretch", xOffset + 5, shouldStretch.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("Background", xOffset + 5, background.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("Depth", xOffset + 5, depth.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("Image Time", xOffset + 5, timePerImage.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		...
		Renderer.drawString("Scale", xOffset + 5, scale.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("Flip Horizontal", xOffset + 5, flippedHorizontally.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("Flip Vertical", xOffset + 5, flippedVertically.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("Mutilply Tint", xOffset + 5, tintColorButton.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("Transparency", xOffset + 5, alphaSlider.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
		Renderer.drawString("Add Tint", xOffset + 5, addTintColorButton.getCenterY() - Renderer.getLineHeight() / 2, 1.0f, batch);
