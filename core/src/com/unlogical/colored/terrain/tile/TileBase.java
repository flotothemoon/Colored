...
public class TileBase extends Tile
{
	...
	public TileBase(TileType type, String metadata, int innerType, float rotation, Vector2 position, Level level, Dimension dimension, TileProperty properties, boolean allowMirrors)
	{
	...
	{
		return hiddenGeometryLevels != null && !hiddenGeometryLevels.contains(this.level.getID()) && !hideAllGeometry;
	}
