	...
	public void clear()
	{
		if (!this.isCleared())
		{
			if (this.level.shouldInverseCages())
			{
				...
				// this.addEmitter(EmitterType.LIGHT_CAGE_CLOSING,
				// this.dimension, new Vector2(0.0f, 0.0f),
				// GameLauncher.TARGET_WIDTH, GameLauncher.TARGET_HEIGHT,
				// EmitterType.LIGHT_CAGE_CLOSING.maxParticles, false, 0);
			}
			else
			{
				// this.transitionEmitter =
				// this.addEmitter(EmitterType.LIGHT_CAGE_OPENING,
				// this.dimension);
			}
