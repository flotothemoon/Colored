...
public class Renderer
{
	...
	private static IExtendedSpriteBatch batch;
	...
	public static IExtendedSpriteBatch useSpriteBatch()
	{
	...
	/**
	 * Modified version of fillArea from libGDX with rotation, origin, scale,
	 * drawSubImages flag and flipX/Y flags
	 */
	public static void fillArea(TextureRegion region, float x, float y, float originX, float originY, float width, float height, float scaleX, float scaleY, float rotation, boolean drawSubImages, Batch batch)
	{
		...
		int regionWidth = (int) (region.getRegionWidth() * scaleX),
				regionHeight = (int) (region.getRegionHeight() * scaleY);
		int fullX = (int) (width / regionWidth),
				fullY = (int) (height / regionHeight);
		float remainingX = width - regionWidth * fullX,
				remainingY = height - regionHeight * fullY;
	...
	{
		batch.setSaturation(saturation);
	}
	...
	public static IExtendedSpriteBatch getUnsafeBatch()
	{
		return batch;
	}
