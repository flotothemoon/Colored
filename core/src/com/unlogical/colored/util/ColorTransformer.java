...
{
	public static final Color colorBuffer1 = new Color(1.0f, 1.0f, 1.0f, 1.0f);
	public static final Color colorBuffer2 = new Color(1.0f, 1.0f, 1.0f, 1.0f);
	...
	public static float[] toHSVColor(Color color, float[] hsv)
	{
		float h = 0.0f;
		float s = 0.0f;
		float v = 0.0f;
